#!/usr/bin/python3
# SaveMan game
#arjith/sample_python
	
import random
print('Welcome to SaveMan Game !')
name = input("What is your name? ")

print("Good Luck ! ", name)

class SaveMan(object):
    ...
    words = '''come on guess the game if you can win it letter baseball python saveman'''.split()

    infStr='_-*\'*-_-*\'*-_-*\'*-_-*\'*-_-*\'*-_-*\'*-_-*\'*-_-*\'*-_-*\'*-_-*\''
  
    def __init__(self, *args, **kwargs):
        i, j = 2, 0
        self.pics.append(self.save[:])
